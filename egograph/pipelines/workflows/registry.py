        ...
        WorkflowDefinition(
            ...
            triggers=(
                TriggerSpec(
                    ...
                    "3h",
                    schedule_name="google_health_same_day_repair",
                    result_summary={"request": {"repair_days": 2}},
                ...
                TriggerSpec(
                    TriggerSpecType.CRON,
                    "30 5 * * sun",
                    schedule_name="google_health_weekly_repair",
                    result_summary={"request": {"repair_days": 45}},
                    use_service_timezone=True,
                ),
            ),
