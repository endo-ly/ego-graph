...
│   ├── README.md
│   ├── browser_history_collection.md
│   ├── chat_history_persistence.md
│   ├── github_worklog_dwh.md
│   ├── mobile_terminal_gateway.md
│   ├── model-selection.md
│   ├── system_prompt_design.md
│   └── youtube_watch_history_collection.md
├── 10.architecture/            # アーキテクチャ設計
│   ├── 1001_system_architecture.md
│   ├── 1002_data_model.md
│   ├── 1004_tech_stack.md
│   └── ingest/
...
- **[01.requirements/](./docs/01.requirements/)**: 実装前の要件定義・設計判断の記録
...
- **[Backend](./docs/40.deploy/backend.md)**: Agent API サーバーのデプロイ手順
- **[Frontend](./docs/40.deploy/frontend-android.md)**: Android アプリのデプロイ手順

### 技術選定記録 (ADR)

- **[20.technical_selections/](./docs/20.technical_selections/README.md)**: 設計判断の記録

### 開発者向けガイド

- **[AGENTS.md](./AGENTS.md)**: 開発ガイドライン、コーディング規約、スキル使用方法
